    ...
    public partial class Form2 : Form
    {
        ...
        private void adaugaInregistrareComenzi()
        {
            ...
            foreach (DataRow r in dataSet1.Model2)
            {
                ...
                {
                    MessageBox.Show("Tabela Consum contine tripletul" + cmbLucrare.SelectedValue + "," + Convert.ToString(d.Day) + "-" + Convert.ToString(d.Month) + "-" + Convert.ToString(d.Year) + "," + r["NrCrt"], "Atentie", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
            cmd.ExecuteNonQuery();
