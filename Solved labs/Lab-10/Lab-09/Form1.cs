...
namespace Lab_09
{
    public partial class Form1 : Form
    {
        ...
        private void A8()
        {
            ...
            cmd.CommandText = "Select IdAuto From Auto where IdProprietar=" + txtIdPersoana.Text; con.Open(); r = cmd.ExecuteReader(); if (r.Read()) { MessageBox.Show("Persoana referita in tabela Auto! Nu se poate sterge!"); con.Close(); return; } con.Close();
        ...
        private void adauga_inregistrare()
        {
            ...
            listaValori = "'" + txtNume.Text + "'" + ",'" + txtCNP.Text + "'" + "," + txtSalariu.Text + "," + cmbLocalitate.SelectedValue + ",'" + txtSpImagine.Text + "'"; cmd.CommandText = "Insert into Persoane(" + listaCampuri + ") " + "Select " + listaValori;
        ...
        private void modifica_inregistrare()
        {
            ...
            listaSet = "Nume = '" + txtNume.Text + "'," + "CNP = '" + txtCNP.Text + "'," + "Salariu = " + txtSalariu.Text + "," + "IdLocalitate = " + cmbLocalitate.SelectedValue + "," + "SpImagine = '" + txtSpImagine.Text + "'";
