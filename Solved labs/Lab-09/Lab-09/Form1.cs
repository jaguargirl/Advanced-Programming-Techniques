...
namespace Lab_09
{
    public partial class Form1 : Form
    {
        ...
        private void A1()
        {
            ...
            dataGridView1.AllowUserToDeleteRows = false;             dataGridView1.ReadOnly = true; 
        ...
        private void configureazaButoane(bool v)
        {
         ...
         {        
             ...
             {           
                 ...
                 cmbLocalitate.DataBindings.Add("Text", persoaneBindingSource, "IDLocalitate"); 
        ...
        {       
            ...
            listaValori = "'" + txtNume.Text + "'" + ",'" + txtCNP.Text + "'" + "," + txtSalariu.Text + "," + cmbLocalitate.SelectedValue + ",'" + txtSpImagine.Text + "'";
